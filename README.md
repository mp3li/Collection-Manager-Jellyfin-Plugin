...
## Current twelve-tab development build
...
| **Create Collections by Folder** | Browse configured Jellyfin library folders, select one folder or multiple folders, preview their combined recursive contents, and create one deduplicated native collection. |
...
| **Logo Focused Art Settings** | Blank placeholder for a later art-settings plan; shown first in the third tab row. |
| **Multi-Collection Gradient Art** | Blank placeholder for a later art-settings plan; shown second in the third tab row. |
...
install the **0.1.0.77 Private Testing** prerelease from the catalog. Restart
Jellyfin and record the real server results in the testing tracker.

## Private test tracking

The twelve-tab development build has automated build and JavaScript syntax checks.
